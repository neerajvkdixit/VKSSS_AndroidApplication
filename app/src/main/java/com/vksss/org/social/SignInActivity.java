...
public class SignInActivity extends AppCompatActivity implements
    ...
    public void sendResultToLoginFragment(JSONObject jsonObject , int code){

        Intent sendResultIntent = new Intent();
        sendResultIntent.putExtra("gmailPerson",jsonObject.toString());
        setResult(code,sendResultIntent);
        finish();
